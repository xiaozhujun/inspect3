...
public class TestJava {
	public static void main(String args[]) throws DocumentException {
		...
		Document document = reader.read(new File("E:/Inspect3/xmlFiles/机修人员点检表.xml"));
...
//	    Node node1=root1Elm.element("devicetype");
		...
		for (Iterator it = nodes.iterator(); it.hasNext();) {
			...
			System.out.println("name:" + elm.attributeValue("name")
					+ "isInput:" + elm.attributeValue("isInput") + " description:"
					+ elm.attributeValue("description") + " unit:"
					+ elm.attributeValue("unit")+"value:"+elm.elementText("value"));
		}
//		try {
