...
import com.springsource.roo.inspect.web.InspectTagController;
...
privileged aspect InspectTagController_Roo_Controller {
    ...
    public String InspectTagController.createForm(Model uiModel) {
        populateEditForm(uiModel, new InspectTag());
        return "inspecttags/create";
    }
    ...
    public String InspectTagController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("inspecttags", InspectTag.findInspectTagEntries(firstResult, sizeNo));
            float nrOfPages = (float) InspectTag.countInspectTags() / sizeNo;
    ...
    public String InspectTagController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, InspectTag.findInspectTag(id));
        return "inspecttags/update";
    }
    ...
    void InspectTagController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("inspectTag_createtime_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    
    void InspectTagController.populateEditForm(Model uiModel, InspectTag inspectTag) {
        uiModel.addAttribute("inspectTag", inspectTag);
        addDateTimeFormatPatterns(uiModel);
    }
    
    String InspectTagController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
